  ...
  <div>
    ...
    <el-row class="navlist" type="flex" justify="space-around" align="middle">
      <el-col class="list-left">
        <el-date-picker v-model="value3" :picker-options="pickerOption" size='small' v-on:change.self="inputchange"></el-date-picker>
    ...
    <el-row>
      <el-col>
        <el-table class="tablelist" v-loading="loading" :data="Table.tableData_prepag" style="width:100%;position:relative;" :height="this.Table.height"
          ...
          <el-table-column show-overflow-tooltip :label="Table.tableData_title[3]" header-align="center" align="center">
